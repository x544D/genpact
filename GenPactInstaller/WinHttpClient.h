...
static const char* WinHC_ = "WinHttpClient";

const size_t cSize = strlen(WinHC_) + 1;
static wchar_t* wc = new wchar_t[cSize];
static size_t n = mbstowcs(wc, WinHC_, cSize);

static wchar_t * SZ_AGENT = wc;
